(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"/Users/davidmonaghan/Workbench/iwantdavid.github.io-builder/node_modules/foundation-sites/js/foundation.js":[function(require,module,exports){
(function (global){
...
},{}],"/Users/davidmonaghan/Workbench/iwantdavid.github.io-builder/node_modules/gsap/src/uncompressed/TweenMax.js":[function(require,module,exports){
(function (global){
/*!
 * VERSION: 1.18.0
 * DATE: 2015-09-05
...
},{}],"/Users/davidmonaghan/Workbench/iwantdavid.github.io-builder/node_modules/jquery/dist/jquery.js":[function(require,module,exports){
(function (global){
; var __browserify_shim_require__=require;(function browserifyShim(module, exports, require, define, browserify_shim__define__module__export__) {
/*!
...
},{}],"/Users/davidmonaghan/Workbench/iwantdavid.github.io-builder/src/script/main":[function(require,module,exports){
var $ = require('jquery');
var foundation = require('foundation');

// var motion = require('mo-js');
...
$(document).ready(function() {
  ...
  $("a").hover(function() {
    ...
    targetElement.bubbles = [];
    [1,2,3].forEach(function(i) {
      targetElement.bubbles[i] = $(targetElement).append('<svg height="100" width="100" class="animated-bubble'+i+'"><circle cx="50" cy="50" r="'+ Math.random() * 23 +'" /></svg>').find(".animated-bubble"+i).css({
        'position': 'absolute',
        'right': '1px',
        'top': '1px'
      });
      TweenMax.to( $(targetElement).find(".animated-bubble"+i), 1, { 
        ease: Circ.easeOut, 
        scale: Math.random() * 0.3, 
        right: "-" + Math.random() * 3 + "rem" }, "start");
      TweenMax.to( $(targetElement).find(".animated-bubble"+i), 0.5, { 
        ease: Circ.easeOut, 
        scale: Math.random() * 0.3, 
        top: "-" + Math.random() * 3 + "rem" }, "start");
    });
  },
    function(){
      var targetElement = this;
      targetElement.bubbles.forEach(function(bubble) {
        if (bubble) {
          TweenMax.to(bubble, 
            Math.random() * 1.2, 
            {
